...
public static b4a.example.timer _timer = null;
  public Object[] GetGlobals() {
		return new Object[] {"credits",Debug.moduleToString(b4a.example.credits.class),"home",Debug.moduleToString(b4a.example.home.class),"Main",Debug.moduleToString(b4a.example.main.class),"pending",Debug.moduleToString(b4a.example.pending.class),"register",Debug.moduleToString(b4a.example.register.class),"scheduler",Debug.moduleToString(b4a.example.scheduler.class),"Service",starter.mostCurrent._service,"timer",Debug.moduleToString(b4a.example.timer.class)};
}
}