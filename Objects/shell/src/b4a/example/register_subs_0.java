...
try {
		Debug.PushSubsStack("Activity_Create (register) ","register",2,register.mostCurrent.activityBA,register.mostCurrent,18);
...
try {
		Debug.PushSubsStack("Activity_Pause (register) ","register",2,register.mostCurrent.activityBA,register.mostCurrent,28);
...
try {
		Debug.PushSubsStack("Activity_Resume (register) ","register",2,register.mostCurrent.activityBA,register.mostCurrent,24);
