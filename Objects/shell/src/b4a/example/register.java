...
public static b4a.example.timer _timer = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",register.mostCurrent._activity,"credits",Debug.moduleToString(b4a.example.credits.class),"home",Debug.moduleToString(b4a.example.home.class),"Main",Debug.moduleToString(b4a.example.main.class),"pending",Debug.moduleToString(b4a.example.pending.class),"scheduler",Debug.moduleToString(b4a.example.scheduler.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"timer",Debug.moduleToString(b4a.example.timer.class)};
}
}